...
public class ArraysUtility {
    ...
    //prints each integer of an integer array in a separate lines
    ...
    //prints each double of a double array in a separate lines
    ...
    //prints each char of a char array in a separate lines
    ...
    //prints each string of a string array in a separate lines
    ...
    //check if the given char is contained in the given array, returns boolean, contains(char [], double)
    ...
    //check if the given string is contained in the given array, returns boolean, contains(String [], double)
